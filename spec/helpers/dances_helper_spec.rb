...
RSpec.describe DancesHelper, type: :helper do
  ...
  [['____ allemande ____ once', 'allemande', nil, nil, 360, 8],
   ...
   ['pull by right', 'pull by for 4', false, 'along', true, 2],
   ['pull by left', 'pull by for 4', false, 'along', false, 2],
   ['pull by right across the set', 'pull by for 4', false, 'across', true, 2],
   ['pull by left across the set', 'pull by for 4', false, 'across', false, 2],
   ['balance & pull by right', 'pull by for 4', true, 'along', true, 8],
   ['balance & pull by left for 6', 'pull by for 4', true, 'along', false, 6],
   ['balance & pull by right across the set', 'pull by for 4', true, 'across', true, 8],
   ...
   ['pull by left hand right diagonal for 4', 'pull by for 4', false, 'right diagonal', false, 4],
   ['gentlespoons pull by right', 'pull by for 2', 'gentlespoons', false, true, 2],
   ...
   ['gyre star clockwise 3 places, gentlespoons backing - gentlespoons take left hands, ladles take right hands, gentlespoons back up, ladles go forward',
   'gyre star', 'gentlespoons', true, 270, 8],
