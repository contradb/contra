...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['if you use ricochets, and the first pass isn\'t just two dancers, then you have to specify a second pass that is', true, 'hey', 'partners', '', false, 'full', 'across', true, false, false, true, 16],
