...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', 'allemande', nil, nil, 360, 8],
    ['partners balance & swing', 'swing', 'partners','balance', 16],
    ['neighbors balance & swing', 'swing', 'neighbors', 'balance', 16],
    ['neighbors swing', 'swing', 'neighbors', 'none', 8],
    ['neighbors balance & swing for 8', 'swing', 'neighbors', 'balance', 8],
    ['partners long swing','swing', 'partners', 'none', 16],
    ['partners swing for 20','swing', 'partners', 'none', 20],
    ['partners balance & swing for 20','swing', 'partners', 'balance', 20],
    ['* * swing for *', 'swing', '*','*', '*'],
    ...
    ['down the hall', 'down the hall', 'everyone', 'all', 'forward', '', 8],
    ['ones down the center', 'down the hall', 'ones', 'center', 'forward', '', 8],
    ['down the hall and turn as a couple', 'down the hall', 'everyone', 'all', 'forward', 'turn-couple', 8],
    ['down the hall and turn alone', 'down the hall', 'everyone', 'all', 'forward', 'turn-alone', 8],
    ['down the hall backward', 'down the hall', 'everyone', 'all', 'backward', '', 8],
    ['up the hall and bend into a ring', 'up the hall', 'everyone', 'all', 'forward', 'circle', 8],
    ['up the hall forward and backward', 'up the hall', 'everyone', 'all', 'forward and backward', '', 8],
    ['twos up the outsides', 'up the hall', 'twos', 'outsides', 'forward', '', 8],
    ['* up the * * and end however for *', 'up the hall', '*', '*', '*', '*', '*'],
    ...
    ['* optional balance & swat the flea for *', 'swat the flea', '*',  '*',  false, '*'],
    ['to ocean wave', 'ocean wave', false, 4],
    ['to ocean wave & balance the wave for 4', 'ocean wave', true, 4],
    ['to ocean wave & balance the wave', 'ocean wave', true, 8],
    ['to ocean wave for 8', 'ocean wave', false, 8],
    ['to ocean wave & maybe balance the wave for *', 'ocean wave', '*', '*'],
    ...
    ['partners meltdown swing', 'meltdown swing', 'partners', 'meltdown', 16],
    ['neighbors meltdown swing for 12', 'meltdown swing', 'neighbors', 'meltdown', 12],
    ['* meltdown swing for *', 'meltdown swing', '*', 'meltdown', '*'],
    ...
    ['zig left zag right into a ring', 'zig zag', 'partners', true, 'ring', 6],
    ['neighbors zig left zag right into a ring for 8', 'zig zag', 'neighbors', true, 'ring', 8],
    ['zig left zag right, trailing two catching hands', 'zig zag', 'partners', true, 'allemande', 6],
    ['zig right zag left, trailing two catching hands, for 8', 'zig zag', 'partners', false, 'allemande', 8],
    ['* zig * zag * ending however for *', 'zig zag', '*', '*', '*', '*'],
