...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['gentlespoons allemande right twice for 10', false, 'allemande', 'gentlespoons', true, 720, 10],
    ['gentlespoons allemande right twice for 12', true, 'allemande', 'gentlespoons', true, 720, 12],
    ...
    ['circle right 5 places for 10', true, 'circle', false, 450, 10],
    ['circle right 4 places for 10', false, 'circle', false, 360, 10],
