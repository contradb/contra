...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['pass through to a left diagonal ocean wave & balance - ladles pass and take left hands while gentlespoons cross and take right hands with neighbors', true, 'form an ocean wave', false, 'left diagonal', true, 'ladles', false, 'neighbors', 8],
    ...
    ['pass through to an ocean wave - ones pass and take left hands while twos cross and take right hands with neighbors', false, 'form an ocean wave', false, 'across', false, 'ones', false, 'neighbors', 2],
  ...
  [['ravens almond right 1½', 'allemande', 'ladles', true, 540, 8],
   ...
   ['pass through to a short wavy line & balance - ravens pass and take right hands while larks cross and take left hands with neighbors', 'form an ocean wave', false, 'across', true, 'ladles', true, 'neighbors', 8],
