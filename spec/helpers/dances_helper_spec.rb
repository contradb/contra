...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['ladles start a half hey - rights in center, lefts on ends', true, 'hey', 'ladles', true, 'half', 'across', 8],
    ['ladles start a half hey - ____ in center, ____ on ends', true, 'hey', 'ladles', nil, 'half', 'across', 8],
    ['ladles start a hey - rights in center, lefts on ends - until ladles meet', false, 'hey', 'ladles', true, 'ladles%%1', 'across', 16],
