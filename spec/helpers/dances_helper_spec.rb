...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['ladles start a half hey - rights in center, lefts on ends', true, 'hey', 'ladles', nil, true, 'half', 'across', false, false, false, false, 8],
    ['ladles start a half hey - ____ in center, ____ on ends - ladles ricochet, gentlespoons ricochet', true, 'hey', 'ladles', nil, nil, 'half', 'across', true, true, false, false, 8],
    ['ladles start a hey - rights in center, lefts on ends - until ladles meet', false, 'hey', 'ladles', nil, true, 'ladles%%1', 'across', false, false, false, false, 16],
    ...
    ['if you use ricochets, and the first pass isn\'t just two dancers, then you have to specify a second pass that is', true, 'hey', 'partners', nil, false, 'full', 'across', true, false, false, true, 16],
    ['only first or second pass may name a single pair of dancers, the other has to name 2 pairs of dancers', true, 'hey', 'ladles', 'gentlespoons', false, 'full', 'across', true, false, false, true, 16],
    ['gentlespoons start a right diagonal full hey - lefts in center, rights on ends', true, 'hey', 'gentlespoons', nil, false, 'full', 'right diagonal', false, false, false, false, 16],
