...
RSpec.describe DancesHelper, type: :helper do
  ...
  [['partners balance & swing', 'swing', 'partners',true, 16],
   ...
   ['pull by up & down the set', 'pull by for 4', false, 'along', true, 2],
   ['pull by left up & down the set', 'pull by for 4', false, 'along', false, 2],
   ['pull by across the set', 'pull by for 4', false, 'across', true, 2],
   ['pull by left across the set', 'pull by for 4', false, 'across', false, 2],
   ['balance & pull by up & down the set', 'pull by for 4', true, 'along', true, 8],
   ['balance & pull by left up & down the set for 6', 'pull by for 4', true, 'along', false, 6],
   ...
   ['hands across star left 4 places', 'star', 'hands across', false, 360, 8],
   ['star right 4 places', 'star', '', true, 360, 8],
   ['wrist grip star left 5 places for 10', 'star', 'wrist grip', false, 450, 10],
