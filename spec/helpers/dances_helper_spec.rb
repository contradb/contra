...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['gentlespoons start a right diagonal hey - lefts in center, rights on ends - until gentlespoons meet the second time', false, 'hey', 'gentlespoons', 'gentlespoons', false, 'gentlespoons%%2', 'right diagonal', false, false, false, false, 8],
