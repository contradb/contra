...
RSpec.describe DancesHelper, type: :helper do
  ...
  TESTS =
   [['____ allemande ____ once', true, 'allemande', nil, nil, 360, 8],
    ...
    ['ladles start a hey - rights in center, lefts on ends - until ladles meet', true, 'hey', 'ladles', '', true, 'ladles%%1', 'across', false, false, false, false, 6],
    ...
    ['gentlespoons start a right diagonal hey - lefts in center, rights on ends - until gentlespoons meet the second time', true, 'hey', 'gentlespoons', 'partners', false, 'gentlespoons%%2', 'right diagonal', false, false, false, false, 12],
    ['gentlespoons start a right diagonal hey - lefts in center, rights on ends - until gentlespoons meet the second time', false, 'hey', 'gentlespoons', 'partners', false, 'gentlespoons%%2', 'right diagonal', false, false, false, false, 18],
    ...
    ['pull by right', true, 'pull by direction', false, 'along', true, 1],
    ['pull by left', true, 'pull by direction', false, 'along', false, 4],
    ['pull by left', false, 'pull by direction', false, 'along', false, 5],
    ...
    ['balance & pull by left', true, 'pull by direction', true, 'along', false, 6],
    ['balance & pull by right across the set', true, 'pull by direction', true, 'across', true, 8],
    ['balance & pull by left across the set', false, 'pull by direction', true, 'across', false, 4],
    ['pull by left across the set', true, 'pull by direction', false, 'across', false, 2],
    ['pull by left diagonal', true, 'pull by direction', false, 'left diagonal', false, 4],
    ['pull by left hand right diagonal', false, 'pull by direction', false, 'right diagonal', false, 5],
    ['pull by right hand left diagonal', true, 'pull by direction', false, 'left diagonal', true, 4],
    ['pull by right diagonal', true, 'pull by direction', false, 'right diagonal', true, 4],
    ['pull by left hand right diagonal', true, 'pull by direction', false, 'right diagonal', false, 4],
    ...
    ['ladles pull by left', false, 'pull by dancers', 'ladles', false, false, 5],
    ['ones balance & pull by left', true, 'pull by dancers', 'ones', true, false, 6],
    ...
    ['partners left hand balance & swat the flea', true, 'swat the flea', 'partners',  true,  false, 8],
    ...
    ['gentlespoons give & take partners', true, 'give & take', 'gentlespoons', 'partners', true, 4],
    ['gentlespoons give & take partners', false, 'give & take', 'gentlespoons', 'partners', true, 3],
    ...
    ['partners right hand balance & box the gnat',  true, 'box the gnat',  'partners',  true,  true,  8],
    ['* optional balance & box the gnat', nil, 'box the gnat',  '*',  '*',  '*',  '*'],
    ['ladles do si do once', true, 'do si do', 'ladles', true, 360, 8],
    ['ladles do si do 1½', false, 'do si do', 'ladles', true, 540, 8],
    ['ladles do si do 1¼', true, 'do si do', 'ladles', true, 450, 8],
