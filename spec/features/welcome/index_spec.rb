    ...
    describe 'figure ... button' do
      ...
      context 'accordion' do
        ...
        it "allemande has the right dancer chooser menu entries" do
          ...
          expect(page).to have_css("option[value='shadows']")
          expect(page).to_not have_css("option[value='prev neigbors']")
          expect(page).to_not have_css("option[value='next neigbors']")
          expect(page).to_not have_css("option[value='2nd neigbors']")
          expect(page).to_not have_css("option[value='3rd neigbors']")
          expect(page).to_not have_css("option[value='4th neigbors']")
