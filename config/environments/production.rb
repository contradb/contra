Rails.application.configure do
  ...
  # Don't Compress JavaScripts - angular likes unmunged variable names. 
  config.assets.js_compressor = Uglifier.new(mangle: false) # was: :uglifier
  # On the glorious day when we cut our Angular dependency, compress JavaScripts and CSS:
  ...
  # config.active_job.queue_name_prefix = "contra_#{Rails.env}"
